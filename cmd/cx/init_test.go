...
func TestManifestConvert(t *testing.T) {
	...
	r := []string{
		"WARN: <service>web</service> build args not migrated to convox.yml, use ARG in your Dockerfile instead\n",
		"WARN: <service>web</service> \"dockerfile\" key is not supported in convox.yml, file must be named \"Dockerfile\"\n",
		"WARN: <service>web</service> \"entrypoint\" key not supported in convox.yml, use ENTRYPOINT in Dockerfile instead\n",
		...
		"WARN: <service>web</service> - port shifting is not supported, use internal hostnames instead\n",
		"WARN: <service>web</service> - environment variables not generated for linked service <service>worker</service>, use internal URL https://worker.<app name>.convox instead\n",
		"WARN: <service>web</service> - multiple ports found, only 1 HTTP port per service is supported\n",
		"WARN: <service>web</service> - only HTTP ports supported\n",
		"WARN: <service>web</service> - UDP ports are not supported\n",
		"WARN: <service>web</service> - only HTTP ports supported\n",
		"WARN: <service>web</service> - privileged mode not supported\n",
