...
func (_m *MockProvider) ResourceList(app string) (types.Resources, error) {
	ret := _m.Called(app)
...
func (_m *MockProvider) SystemUninstall(name string, opts types.SystemInstallOptions) error {
	ret := _m.Called(name, opts)
