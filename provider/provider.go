...
type Provider interface {
	...
	ResourceCreate(name, kind string, params map[string]string) (*types.Resource, error)
	ResourceGet(name string) (*types.Resource, error)
	ResourceList() (types.Resources, error)
